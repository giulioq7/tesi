...
class mealy : public fm<pair<In, Out> >
{
	...
	fm< pair<In, Out> >::arcs;		// set of instructions
	fm< pair<In, Out> >::start_states;	// set of start states
	fm< pair<In, Out> >::final_states;	// set of final states
	fm< pair<In, Out> >::all_states;
	fm< pair<In, Out> >::is_deterministic;
