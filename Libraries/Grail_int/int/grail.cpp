...
//				ist >> str;
      ...
      case 3: // automaton is arriving on stdin
        ...
        fio.close();
        size = strlen(argv[2]);
        str = str.assign(&y, size);
//				ist >> str;
        break;
      case 2:
        size = strlen(argv[1]);

        str = str.assign(&x, size);
//				ist >> str;
        std::cin >> a;
        break;
...
void
get_one(fl<int>& a, int argc, char** argv, char* my_name)
{
  std::fstream f_arg;
...
void
get_two(fl<int>& a, string<int>&b, int argc, char** argv, char* my_name)
{
  std::fstream f_arg;
  std::fstream g_arg;
  std::istrstream ist(argv[argc - 1]);
...
void
get_one(afa<int>& a, int argc, char** argv, char* my_name)
{
  std::fstream f_arg;
...
void
get_two(afa<int>& a, afa<int>& b, int argc, char** argv, char* my_name)
{
  std::fstream f_arg;
  std::fstream g_arg;
...
void
get_afa(afa<int>& a, int argc, char** argv, char* my_name)
{
  std::fstream f_arg;
